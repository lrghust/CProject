    ...
    {    /*循环*/
        ...
        else if (inRec.EventType == KEY_EVENT && inRec.Event.KeyEvent.bKeyDown)
        {
            ...
            else
            {
                ...
                if(vkc==8)//退格
                {
                    if(bInfo.dwCursorPosition.X>pHotArea->pArea[*piHot-1].Left)//不越过左边界
                    {
                ...
                else if(bInfo.dwCursorPosition.X<pHotArea->pArea[*piHot-1].Right)//不越过右边界
                {
